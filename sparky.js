...
"fileName": `${ownername}${xeonbrutal(prefix)}`,
...
let buttonMessage = {
image: {url: `https://i.ibb.co/vXnjzpr/cheemspic.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
mediaType:1,
mediaUrl: 'https://youtube.com/@dreamguyAhmad Chen Dev',
sourceUrl: "https://youtube.com/@dreamguyAhmad Chen Dev"
}}
}
...
case 'tiktoknowm':
			...
			case 'tt':
				...
				let nih = `   ${author} SUBSCRIBE https://www.youtube.com/@sparkymon777`
				let buttons = [
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER Ahmad Chen Dev`,
}
}}), { userJid: m.chat, quoted: doc})
XeonBotInc.relayMessage(num, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
...
`
      let ments = [ownernya, me, ini_mark]        
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'ALL MENU' }, type: 1 },{ buttonId: 'command', buttonText: { displayText: 'LIST MENU' }, type: 1 },{ buttonId: 'sc', buttonText: { displayText: 'OWNER GANTENG' }, type: 1 }]
            let buttonMessage = {
	...
	const sections = [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "ALL MENU",
										"description": "KawaiNime BOT+  Ahmad Chen Dev",
...
let fot = `MADE BY DREAM GUY Ahmad Chen Dev
`
const listMessage = {
footer: fot,
text: 'Made By Ahmad Chen Dev',
title: con,
